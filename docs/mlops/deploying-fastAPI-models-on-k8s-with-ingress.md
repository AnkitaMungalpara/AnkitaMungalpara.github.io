---
title: 'Kubernetes Part 1: Ingress & FastAPI Model Deployment'
date: 2025-08-15
...
[View on GitHub](https://github.com/AnkitaMungalpara/kubernetes-fastapi-deployment){: .btn }

![](https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Kubernetes_logo.svg/1024px-Kubernetes_logo.svg.png)
...
![](https://cdn.prod.website-files.com/61c02e339c11997e6926e3d9/61c093a693fd42c2d52eb62a_602c569e5e6e7537bc35799a_TYU0FzP808wO7i21lCVLrwNQHDid7p-DEEKPX7y61O4Yqe17MWvMU4gVS6ZcSWYEz0jbwQ6LSCRv4rw5zsKH-6CBYn95EDvZ5Sh4BprrkBx821ylBC85xb710oIBfirSbxtjzFs.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*hFoNrZ1RXXp3Cl_d.png)
...
```
![](../../assets/images/k8s/web-server-result.png)
...
![](https://stacksimplify.com/course-images/azure-kubernetes-service-namespaces-2.png)
